...
<head>
    ...
    <link rel="stylesheet" href="/src/headder/delivery_order.css"> 
    ...
    <div id="app">
        ...
        <div class="table">
            ...
            <div class="separator"></div> 
                <a href="/src/headder/sell_now.html" class="order-history">สินค้าที่กำลังขายอยู่</a>
            <div class="separator"></div> 
        ...
        <div class="custom-div">
            ...
            <div class="info-item">
              <p class="info-label">ข้อมูลสกุล</p>
            </div>
            <div class="info-item">
